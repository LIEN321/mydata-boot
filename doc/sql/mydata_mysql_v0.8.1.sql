CREATE DATABASE IF NOT EXISTS `mydata` CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_general_ci';
...
CREATE TABLE `md_project`  (
  ...
  `project_desc` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '0' COMMENT '项目描述',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `md_task`  (
    ...
    `single_mode` int(0) NULL DEFAULT NULL COMMENT '单条记录消费模式，1-对象、2-集合',
