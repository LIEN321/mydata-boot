/*
 ...
 Source Server         : haier_local
 Source Server Type    : MySQL
 Source Server Version : 80403
 Source Host           : svc-dev:3306
 Source Schema         : mydata_install

 Target Server Type    : MySQL
 Target Server Version : 80403
 File Encoding         : 65001

 Date: 20/12/2025 21:55:29
*/
...
CREATE TABLE `md_pipeline`  (
  ...
  `email_strategy` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '邮件通知策略',
  ...
  `retry` int(0) NULL DEFAULT 0 COMMENT '失败重试次数，默认0：不重试',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `md_pipeline_history`  (
  ...
  `trigger_param` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '触发时的入参',
  ...
  `execution_count` int(0) NULL DEFAULT 0 COMMENT '执行次数（重试会增加）',
  PRIMARY KEY (`id`) USING BTREE
