...
CREATE TABLE `md_api`  (
  ...
  `resp_config` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '响应配置',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `md_app`  (
  ...
  `req_headers` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '请求Header',
  `auth_type` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '认证类型',
  `auth_config` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '认证配置',
  `resp_config` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '响应配置',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `md_pipeline`  (
  ...
  `email_strategy` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '0' COMMENT '邮件通知策略',
...
CREATE TABLE `md_pipeline_history`  (
  ...
  `trigger_param` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '触发时的入参',
...
CREATE TABLE `md_pipeline_task`  (
  ...
  `pre_condition` int(0) NULL DEFAULT 1 COMMENT '后续的前提条件：0-ALWAYS，1-SUCCESS',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
-- Table structure for md_pipeline_var
-- ----------------------------
...
CREATE TABLE `md_pipeline_var`  (
  ...
  `update_user` bigint(0) NULL DEFAULT NULL COMMENT '更新人',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  `status` int(0) NULL DEFAULT NULL COMMENT '有效状态：0-无效，1-有效',
  `is_deleted` int(0) NULL DEFAULT 0 COMMENT '删除状态：0-未删除，1-已删除',
  `create_department` bigint(0) NULL DEFAULT NULL COMMENT '创建部门id',
  `update_department` bigint(0) NULL DEFAULT NULL COMMENT '更新部门id',
  `tenant_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '租户id',
  `pipeline_id` bigint(0) NULL DEFAULT NULL COMMENT '所属流水线',
  `var_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '变量编号',
  `var_value` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '变量值',
  `var_desc` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '变量描述',
  `var_type` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT 'string' COMMENT '变量值类型',
  `is_hide` int(0) NULL DEFAULT 0 COMMENT '是否不显示值，0-不隐藏、1-隐藏',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '流水线变量' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of md_pipeline_var
-- ----------------------------
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1827994143199465474, 1827994143199465474, '2025-01-01 00:00:00', 1827994143199465474, '2025-09-09 09:03:27', 1, 0, NULL, 1828330175358709761, '0000000000', 'admin', '管理员', '', '', 1828330175358709761, 1828617675955326978, 'admin', 'a0d4d7bf18c11082bc4bb47c64e7087b4dd810b779954bff69cc7bfee8360bbc', 'yIUffy0zAuGIw38LYf02AZdk2DYsvc39', '/images/default_avatar.png', 1);
