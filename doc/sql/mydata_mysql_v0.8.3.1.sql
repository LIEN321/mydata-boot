...
CREATE TABLE `blade_client`  (
  ...
  `is_deleted` int(0) NOT NULL COMMENT '是否已删除',
...
-- ----------------------------
INSERT INTO `blade_client` VALUES (1123598811738675201, 'sword', 'sword_secret', NULL, 'all', 'refresh_token,password,authorization_code', 'http://localhost:8888', NULL, 3600, 604800, NULL, NULL, 1, 1123598813738675201, '2019-03-24 10:40:55', 1, '2019-03-24 10:40:59', 1, 0);
INSERT INTO `blade_client` VALUES (1123598811738675202, 'saber', 'saber_secret', NULL, 'all', 'refresh_token,password,authorization_code', 'http://localhost:8080', NULL, 3600, 604800, NULL, NULL, 1, 1123598813738675201, '2019-03-24 10:42:29', 1, '2019-03-24 10:42:32', 1, 0);
...
CREATE TABLE `blade_code`  (
  `id` bigint(0) NOT NULL COMMENT '主键',
  `datasource_id` bigint(0) NULL DEFAULT NULL COMMENT '数据源主键',
  ...
  `base_mode` int(0) NULL DEFAULT NULL COMMENT '基础业务模式',
  `wrap_mode` int(0) NULL DEFAULT NULL COMMENT '包装器模式',
...
CREATE TABLE `blade_datasource`  (
  ...
  `is_deleted` int(0) NULL DEFAULT NULL COMMENT '是否已删除',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `blade_dept` VALUES (1123598813738675201, '000000', 0, '0', '刀锋科技', '江苏刀锋科技有限公司', 1, NULL, 0);
INSERT INTO `blade_dept` VALUES (1123598813738675202, '000000', 1123598813738675201, '0,1123598813738675201', '常州刀锋', '常州刀锋科技有限公司', 1, NULL, 0);
INSERT INTO `blade_dept` VALUES (1123598813738675203, '000000', 1123598813738675201, '0,1123598813738675201', '苏州刀锋', '苏州刀锋科技有限公司', 1, NULL, 0);
...
INSERT INTO `blade_menu` VALUES (1123598815738675205, 1123598815738675203, 'dept', '部门管理', 'menu', '/system/dept', NULL, 2, 1, 0, 1, NULL, 0);
...
INSERT INTO `blade_menu` VALUES (1164733389668962251, 1123598815738675203, 'post', '岗位管理', 'menu', '/system/post', '', 2, 1, 0, 1, NULL, 0);
...
INSERT INTO `blade_menu` VALUES (1545322605295689729, 0, 'mydata_manage', '数据融合', 'menu', '/manage', 'swap', 100, 1, 1, 1, '', 0);
INSERT INTO `blade_menu` VALUES (1545323164115394561, 1545322605295689729, 'data', '数据管理', 'menu', '/manage/data', NULL, 1, 1, 0, 1, NULL, 0);
INSERT INTO `blade_menu` VALUES (1545323164115394562, 1545323164115394561, 'data_add', '新增', 'add', '/manage/data/add', 'plus', 1, 2, 1, 1, NULL, 0);
INSERT INTO `blade_menu` VALUES (1545323164115394563, 1545323164115394561, 'data_edit', '修改', 'edit', '/manage/data/edit', 'form', 2, 2, 2, 1, NULL, 0);
INSERT INTO `blade_menu` VALUES (1545323164115394564, 1545323164115394561, 'data_delete', '删除', 'delete', '/api/mydata-manage/data/remove', 'delete', 3, 2, 3, 1, NULL, 0);
INSERT INTO `blade_menu` VALUES (1545323164115394565, 1545323164115394561, 'data_view', '查看', 'view', '/manage/data/view', 'file-text', 4, 2, 2, 1, NULL, 0);
INSERT INTO `blade_menu` VALUES (1545427898142810114, 1545322605295689729, 'api', 'API管理', 'menu', '/manage/api', '', 3, 1, 0, 1, '', 0);
INSERT INTO `blade_menu` VALUES (1545427898142810115, 1545427898142810114, 'api_add', '新增', 'add', '/manage/api/add', 'plus', 1, 2, 1, 1, NULL, 0);
INSERT INTO `blade_menu` VALUES (1545427898142810116, 1545427898142810114, 'api_edit', '修改', 'edit', '/manage/api/edit', 'form', 2, 2, 2, 1, NULL, 0);
INSERT INTO `blade_menu` VALUES (1545427898142810117, 1545427898142810114, 'api_delete', '删除', 'delete', '/api/mydata-manage/api/remove', 'delete', 3, 2, 3, 1, NULL, 0);
INSERT INTO `blade_menu` VALUES (1545427898142810118, 1545427898142810114, 'api_view', '查看', 'view', '/manage/api/view', 'file-text', 4, 2, 2, 1, NULL, 0);
INSERT INTO `blade_menu` VALUES (1546341857284841474, 1545322605295689729, 'env', '环境管理', 'menu', '/manage/env', '', 5, 1, 0, 1, '', 0);
INSERT INTO `blade_menu` VALUES (1546341857284841475, 1546341857284841474, 'env_add', '新增', 'add', '/manage/env/add', 'plus', 1, 2, 1, 1, NULL, 0);
INSERT INTO `blade_menu` VALUES (1546341857284841476, 1546341857284841474, 'env_edit', '修改', 'edit', '/manage/env/edit', 'form', 2, 2, 2, 1, NULL, 0);
INSERT INTO `blade_menu` VALUES (1546341857284841477, 1546341857284841474, 'env_delete', '删除', 'delete', '/api/mydata-manage/env/remove', 'delete', 3, 2, 3, 1, NULL, 0);
INSERT INTO `blade_menu` VALUES (1546341857284841478, 1546341857284841474, 'env_view', '查看', 'view', '/manage/env/view', 'file-text', 4, 2, 2, 1, NULL, 0);
INSERT INTO `blade_menu` VALUES (1546392469737299969, 1545322605295689729, 'task', '任务管理', 'menu', '/manage/task', '', 4, 1, 0, 1, '', 0);
INSERT INTO `blade_menu` VALUES (1546392469737299970, 1546392469737299969, 'task_add', '新增', 'add', '/manage/task/add', 'plus', 1, 2, 1, 1, NULL, 0);
INSERT INTO `blade_menu` VALUES (1546392469737299971, 1546392469737299969, 'task_edit', '修改', 'edit', '/manage/task/edit', 'form', 2, 2, 2, 1, NULL, 0);
INSERT INTO `blade_menu` VALUES (1546392469737299972, 1546392469737299969, 'task_delete', '删除', 'delete', '/api/mydata-manage/task/remove', 'delete', 3, 2, 3, 1, NULL, 0);
INSERT INTO `blade_menu` VALUES (1546392469737299973, 1546392469737299969, 'task_view', '查看', 'view', '/manage/task/view', 'file-text', 4, 2, 2, 1, NULL, 0);
INSERT INTO `blade_menu` VALUES (1620321974120275969, 1545322605295689729, 'app', '应用管理', 'menu', '/manage/app', NULL, 2, 1, 0, 1, NULL, 0);
INSERT INTO `blade_menu` VALUES (1620322693665710082, 1620321974120275969, 'app_add', '新增', 'add', '/manage/app/add', 'plus', 1, 2, 1, 1, NULL, 0);
INSERT INTO `blade_menu` VALUES (1620322881964793858, 1620321974120275969, 'app_edit', '修改', 'edit', '/manage/app/edit', 'form', 2, 2, 2, 1, NULL, 0);
INSERT INTO `blade_menu` VALUES (1620323080615419905, 1620321974120275969, 'app_delete', '删除', 'delete', '/api/mydata-manage/app/remove', 'delete', 3, 2, 3, 1, NULL, 0);
INSERT INTO `blade_menu` VALUES (1620323332772782081, 1620321974120275969, 'app_view', '查看', 'view', '/manage/app/view', 'file-text', 4, 2, 2, 1, NULL, 0);
INSERT INTO `blade_menu` VALUES (1719658520153088001, 1546341857284841474, 'env_var', '变量管理', 'env_var', ' ', NULL, 5, 2, 2, 1, NULL, 0);
INSERT INTO `blade_menu` VALUES (1732045113141497858, 1545322605295689729, 'project', '项目管理', 'menu', '/manage/project', NULL, 0, 1, 0, 1, NULL, 0);
INSERT INTO `blade_menu` VALUES (1732045113141497859, 1732045113141497858, 'project_add', '新增', 'add', '/manage/project/add', 'plus', 1, 2, 1, 1, NULL, 0);
INSERT INTO `blade_menu` VALUES (1732045113141497860, 1732045113141497858, 'project_edit', '修改', 'edit', '/manage/project/edit', 'form', 2, 2, 2, 1, NULL, 0);
INSERT INTO `blade_menu` VALUES (1732045113141497861, 1732045113141497858, 'project_delete', '删除', 'delete', '/api/mydata-manage/project/remove', 'delete', 3, 2, 3, 1, NULL, 0);
INSERT INTO `blade_menu` VALUES (1732045113141497862, 1732045113141497858, 'project_view', '查看', 'view', '/manage/project/view', 'file-text', 4, 2, 2, 1, NULL, 0);
...
CREATE TABLE `blade_notice`  (
  ...
  `category` int(0) NULL DEFAULT NULL COMMENT '类型',
...
CREATE TABLE `blade_post`  (
  `id` bigint(0) NOT NULL COMMENT '主键',
  `tenant_id` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '000000' COMMENT '租户ID',
  `category` int(0) NULL DEFAULT NULL COMMENT '岗位类型',
...
-- ----------------------------
INSERT INTO `blade_role_menu` VALUES (1769765739543736321, 1123598815738675203, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739556319233, 1123598815738675204, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739560513537, 1123598815738675223, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739564707841, 1123598815738675224, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739573096449, 1123598815738675225, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739585679362, 1123598815738675226, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739598262273, 1123598815738675227, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739602456577, 1123598815738675228, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739610845185, 1123598815738675205, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739619233794, 1123598815738675229, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739623428097, 1123598815738675230, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739631816706, 1123598815738675231, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739636011010, 1123598815738675232, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739640205313, 1123598815738675206, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739644399618, 1123598815738675233, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739665371138, 1123598815738675234, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739669565442, 1123598815738675235, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739677954050, 1123598815738675236, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739682148354, 1123598815738675207, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739686342658, 1123598815738675237, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739694731265, 1123598815738675238, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739703119874, 1123598815738675239, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739707314177, 1123598815738675240, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739715702785, 1123598815738675209, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739719897090, 1123598815738675245, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739728285698, 1123598815738675246, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739732480001, 1123598815738675247, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739736674305, 1123598815738675248, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739745062913, 1123598815738675256, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739749257218, 1123598815738675257, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739757645825, 1123598815738675258, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739761840130, 1123598815738675259, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739770228738, 1123598815738675260, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739774423042, 1123598815738675261, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739778617345, 1123598815738675262, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739787005953, 1123598815738675263, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739795394561, 1123598815738675264, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739799588865, 1123598815738675265, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739803783170, 1164733389668962251, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739807977474, 1164733389668962252, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739816366082, 1164733389668962253, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739820560385, 1164733389668962254, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739824754690, 1164733389668962255, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739828948994, 1123598815738675241, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739837337602, 1123598815738675308, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739841531906, 1123598815738675307, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739845726210, 1123598815738675242, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739854114818, 1123598815738675243, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739883474945, 1123598815738675244, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739891863554, 1123598815738675309, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739896057857, 1123598815738675310, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739904446466, 1164733399668962201, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739908640769, 1164733399668962202, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739912835074, 1164733399668962203, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739921223682, 1164733399668962204, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739929612290, 1164733399668962205, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739933806594, 1164733399668962206, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739942195202, 1164733399668962207, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739946389505, 1545323164115394561, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739950583809, 1545323164115394562, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739958972417, 1545323164115394563, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739963166721, 1545323164115394564, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739967361026, 1545323164115394565, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739975749633, 1545427898142810114, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739979943937, 1545427898142810115, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739984138242, 1545427898142810116, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765739984138243, 1545427898142810117, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765740000915457, 1545427898142810118, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765740000915458, 1546341857284841474, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765740000915459, 1546341857284841475, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765740030275586, 1546341857284841476, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765740034469890, 1546341857284841477, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765740038664194, 1546341857284841478, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765740047052801, 1719658520153088001, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765740051247106, 1546392469737299972, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765740059635714, 1546392469737299973, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765740068024321, 1620321974120275969, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765740076412930, 1620322693665710082, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765740084801538, 1620322881964793858, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765740093190145, 1620323080615419905, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765740097384450, 1620323332772782081, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765740109967361, 1732045113141497858, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765740114161666, 1732045113141497859, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765740118355970, 1732045113141497860, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765740126744577, 1732045113141497861, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765740130938881, 1732045113141497862, 1123598816738675201);
INSERT INTO `blade_role_menu` VALUES (1769765758262915073, 1545323164115394561, 1123598816738675202);
INSERT INTO `blade_role_menu` VALUES (1769765758283886594, 1545323164115394562, 1123598816738675202);
INSERT INTO `blade_role_menu` VALUES (1769765758296469505, 1545323164115394563, 1123598816738675202);
INSERT INTO `blade_role_menu` VALUES (1769765758300663809, 1545323164115394564, 1123598816738675202);
INSERT INTO `blade_role_menu` VALUES (1769765758309052417, 1545323164115394565, 1123598816738675202);
INSERT INTO `blade_role_menu` VALUES (1769765758313246722, 1545427898142810114, 1123598816738675202);
INSERT INTO `blade_role_menu` VALUES (1769765758321635329, 1545427898142810115, 1123598816738675202);
INSERT INTO `blade_role_menu` VALUES (1769765758325829634, 1545427898142810116, 1123598816738675202);
INSERT INTO `blade_role_menu` VALUES (1769765758334218242, 1545427898142810117, 1123598816738675202);
INSERT INTO `blade_role_menu` VALUES (1769765758342606850, 1545427898142810118, 1123598816738675202);
INSERT INTO `blade_role_menu` VALUES (1769765758346801154, 1546341857284841474, 1123598816738675202);
INSERT INTO `blade_role_menu` VALUES (1769765758355189762, 1546341857284841475, 1123598816738675202);
INSERT INTO `blade_role_menu` VALUES (1769765758363578369, 1546341857284841476, 1123598816738675202);
INSERT INTO `blade_role_menu` VALUES (1769765758367772673, 1546341857284841477, 1123598816738675202);
INSERT INTO `blade_role_menu` VALUES (1769765758380355586, 1546341857284841478, 1123598816738675202);
INSERT INTO `blade_role_menu` VALUES (1769765758384549890, 1719658520153088001, 1123598816738675202);
INSERT INTO `blade_role_menu` VALUES (1769765758392938497, 1546392469737299972, 1123598816738675202);
INSERT INTO `blade_role_menu` VALUES (1769765758409715713, 1546392469737299973, 1123598816738675202);
INSERT INTO `blade_role_menu` VALUES (1769765758413910017, 1620321974120275969, 1123598816738675202);
INSERT INTO `blade_role_menu` VALUES (1769765758422298626, 1620322693665710082, 1123598816738675202);
INSERT INTO `blade_role_menu` VALUES (1769765758451658753, 1620322881964793858, 1123598816738675202);
INSERT INTO `blade_role_menu` VALUES (1769765758460047362, 1620323080615419905, 1123598816738675202);
INSERT INTO `blade_role_menu` VALUES (1769765758472630274, 1620323332772782081, 1123598816738675202);
INSERT INTO `blade_role_menu` VALUES (1769765758481018881, 1732045113141497858, 1123598816738675202);
INSERT INTO `blade_role_menu` VALUES (1769765758485213186, 1732045113141497859, 1123598816738675202);
INSERT INTO `blade_role_menu` VALUES (1769765758497796098, 1732045113141497860, 1123598816738675202);
INSERT INTO `blade_role_menu` VALUES (1769765758501990402, 1732045113141497861, 1123598816738675202);
INSERT INTO `blade_role_menu` VALUES (1769765758506184705, 1732045113141497862, 1123598816738675202);
...
CREATE TABLE `blade_role_scope`  (
  `id` bigint(0) NOT NULL COMMENT '主键',
  `scope_id` bigint(0) NULL DEFAULT NULL COMMENT '数据权限id',
  `role_id` bigint(0) NULL DEFAULT NULL COMMENT '角色id',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `blade_scope_data`  (
  ...
  `scope_type` int(0) NULL DEFAULT NULL COMMENT '数据权限类型',
...
-- ----------------------------
INSERT INTO `blade_tenant` VALUES (1123598820738675201, '000000', '管理组', '', 'admin', '666666', '管理组', 1123598821738675201, 1123598813738675201, '2019-01-01 00:00:39', 1123598821738675201, '2024-03-19 00:42:15', 1, 0, 'host');
...
CREATE TABLE `blade_user`  (
  ...
  `sex` smallint(0) NULL DEFAULT NULL COMMENT '性别',
...
INSERT INTO `blade_user` VALUES (1762833970961657857, '000000', NULL, 'demo', 'a69681bcf334ae130217fea4505fd3c994f5683f', '演示账号', 'demo', NULL, '', NULL, NULL, NULL, '1123598816738675202', '1123598813738675201', '1123598817738675208', 1123598821738675201, NULL, '2024-02-28 21:35:45', 1123598821738675201, '2024-02-28 21:35:45', 1, 0);
...
CREATE TABLE `md_api`  (
  ...
  `api_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '接口名称',
  `op_type` int(0) NULL DEFAULT NULL COMMENT '操作类型，1-提供数据、2-消费数据',
  `api_method` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '接口请求方法',
  `api_uri` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '接口相对路径',
  `data_type` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '接口数据类型：JSON',
  `req_headers` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '接口请求Header',
  `req_params` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '接口请求参数',
...
CREATE TABLE `md_data`  (
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  `tenant_id` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '所属租户',
  `data_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '数据编号',
  `data_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '数据名称',
  `data_count` int(0) NULL DEFAULT 0 COMMENT '数据量',
  `project_id` bigint(0) NULL DEFAULT NULL COMMENT '所属项目',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '标准数据项' ROW_FORMAT = Dynamic;
...
CREATE TABLE `md_data_field`  (
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  `tenant_id` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '所属租户',
  `data_id` bigint(0) NULL DEFAULT NULL COMMENT '所属数据项',
  `field_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '字段编号',
  `field_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '字段名称',
  `is_id` int(0) NULL DEFAULT NULL COMMENT '是否标识，0-不是、1-是',
  `field_type` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '字段类型',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '标准数据项字段' ROW_FORMAT = Dynamic;
...
CREATE TABLE `md_env`  (
  ...
  `env_prefix` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '前置路径',
  `global_headers` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '全局header参数',
  `global_params` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '全局变量',
  `sync_task_time` datetime(0) NULL DEFAULT NULL COMMENT '同步到任务的时间',
  `project_id` bigint(0) NULL DEFAULT NULL COMMENT '所属项目',
  `sort` int(0) NULL DEFAULT NULL COMMENT '排序',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
-- Table structure for md_env_var
-- ----------------------------
...
CREATE TABLE `md_env_var`  (
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  `tenant_id` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '所属租户',
  `env_id` bigint(0) NULL DEFAULT NULL COMMENT '所属环境id',
  `var_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '变量名',
  `var_value` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '变量值',
  `is_hidden` int(0) NULL DEFAULT 0 COMMENT '是否隐藏明文，0-不隐藏、1-隐藏',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '环境变量' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of md_env_var
-- ----------------------------
...
CREATE TABLE `md_project`  (
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  `tenant_id` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '所属租户',
  `project_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '项目编号',
  `project_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '项目名称',
  `project_desc` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '项目描述',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `md_task`  (
  ...
  `env_id` bigint(0) NULL DEFAULT NULL COMMENT '所属环境',
  `api_id` bigint(0) NULL DEFAULT NULL COMMENT '所属应用接口',
  `api_url` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '接口完整地址',
  `op_type` int(0) NULL DEFAULT NULL COMMENT '操作类型，1-提供数据、2-消费数据',
  `api_method` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '接口请求类型',
  `data_id` bigint(0) NULL DEFAULT NULL COMMENT '所属数据',
  `task_period` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '任务周期',
  `api_field_prefix` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '字段层级前缀',
  `field_mapping` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '字段映射',
  `task_status` int(0) NULL DEFAULT 0 COMMENT '运行状态：0-停止，1-运行，2-异常',
  `data_type` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '接口数据类型：JSON',
  `data_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '数据编号',
  `id_field_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '数据主键字段编号',
  `is_subscribed` int(0) NULL DEFAULT 0 COMMENT '是否为订阅任务：0-不订阅，1-订阅',
  `req_headers` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '接口请求Header',
  `req_params` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '接口请求参数',
  `data_filter` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '数据的过滤条件',
  `last_run_time` datetime(0) NULL DEFAULT NULL COMMENT '最后执行时间',
  `last_success_time` datetime(0) NULL DEFAULT NULL COMMENT '最后成功时间',
  `field_var_mapping` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '接口字段与变量名的映射',
  `app_id` bigint(0) NULL DEFAULT NULL COMMENT '所属应用id',
  `project_id` bigint(0) NULL DEFAULT NULL COMMENT '所属项目',
  `ref_env_id` bigint(0) NULL DEFAULT NULL COMMENT '跨环境任务的对应目标环境id',
  `ref_op_type` int(0) NULL DEFAULT NULL COMMENT '跨环境任务的对应操作类型',
  `batch_status` int(0) NULL DEFAULT 0 COMMENT '分批启用状态：0-不启用，1-启用',
  ...
  `consume_mode` int(0) NULL DEFAULT 0 COMMENT '消费数据模式，默认1，1-API、2-发邮件',
  ...
  `produce_mode` int(0) NULL DEFAULT 0 COMMENT '提供数据模式，默认1，1-API、2-接收推送',
  ...
  `req_body` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '请求体',
  `same_batch` int(0) NULL DEFAULT 1 COMMENT '是否复用父任务批次数据，0-不复用、1-复用',
  `clean_html` int(0) NULL DEFAULT 0 COMMENT '是否清除HTML标签，0-不清除、1-清除',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
-- Table structure for md_task_log
-- ----------------------------
...
CREATE TABLE `md_task_log`  (
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  `tenant_id` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '所属租户',
  `task_id` bigint(0) NULL DEFAULT NULL COMMENT '所属任务',
  `task_start_time` datetime(0) NULL DEFAULT NULL COMMENT '执行开始时间',
  `task_end_time` datetime(0) NULL DEFAULT NULL COMMENT '执行结束时间',
  `task_result` int(0) NULL DEFAULT NULL COMMENT '执行结果（0-不执行，1-成功）',
  `task_detail` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '执行内容',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '集成任务日志' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of md_task_log
-- ----------------------------
